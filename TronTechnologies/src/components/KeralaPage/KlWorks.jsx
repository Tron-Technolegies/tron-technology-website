    ...
    <section className="bg-white text-black font-manrope py-16 px-6 md:px-12">
      <div className="mb-20 max-w-4xl mx-auto">
        ...
        <p className="text-gray-400">
          We've loved working with many fantastic companies, <br /> and are really proud of what
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center max-w-4xl mx-auto">
        ...
        <div>
          ...
          <p className="text-gray-400 mb-8">Build a unique website. Figma/WordPress template</p>
          <div className="flex flex-wrap gap-3">
            <span className="border px-4 py-1 rounded-full text-sm">Website</span>
            <span className="border px-4 py-1 rounded-full text-sm">Branding</span>
            <span className="border px-4 py-1 rounded-full text-sm">Application</span>
          </div>
        </div>

        <div className="order-2 md:order-1">
          <h3 className="text-2xl font-semibold mb-2">Application Design</h3>
          <p className="text-gray-400 mb-4">Build a unique website. Figma/WordPress template</p>
          <div className="flex flex-wrap gap-3">
            <span className="border px-4 py-1 rounded-full text-sm">Website</span>
            <span className="border px-4 py-1 rounded-full text-sm">Branding</span>
            <span className="border px-4 py-1 rounded-full text-sm">Application</span>
        ...
        <div className="relative order-1 md:order-2">
          <img src="/work2.png" alt="App Project" className="rounded-xl shadow-lg" />
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center max-w-4xl mx-auto">
        ...
        <div className="order-2 md:order-1">
          <h3 className="text-2xl font-semibold mb-2">Application Design</h3>
          <p className="text-gray-600 mb-4">Build a unique website. Figma/WordPress template</p>
          <div className="flex flex-wrap gap-3">
            <span className="border px-4 py-1 rounded-full text-sm">Website</span>
            <span className="border px-4 py-1 rounded-full text-sm">Branding</span>
            <span className="border px-4 py-1 rounded-full text-sm">Application</span>
        ...
        <div className="relative order-1 md:order-2">
          <img src="/work4.png" alt="App Project" className="rounded-xl shadow-lg" />
          <button className="absolute bottom-4 right-4 bg-black text-white w-10 h-10 rounded-full flex items-center justify-center">
            →
          </button>
        </div>
